...
heading_label = Label(text="Timer", font=(FONT_NAME, 35, "bold"), bg=YELLOW, fg=GREEN)
...
ticks = Label(bg=YELLOW, padx=5, pady=25, fg=GREEN, font=(FONT_NAME, 7, "bold"))
ticks.grid(row=3, column=1)

reset_button = Button(text="Reset", highlightthickness=0, font=(FONT_NAME, 10, "bold"), command=reset)
